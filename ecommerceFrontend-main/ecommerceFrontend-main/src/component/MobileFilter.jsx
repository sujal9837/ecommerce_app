...
const MobileFilter = ({ openFilter, setOpenFilter, search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory, handleBrandChange,categoryOnlyData, handleCategoryChange }) => {
    const {  brandOnlyData } = []
