...
const FilterSection = ({search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory, handleBrandChange,categoryOnlyData, handleCategoryChange}) => {
    const { brandOnlyData } = []
    return (
