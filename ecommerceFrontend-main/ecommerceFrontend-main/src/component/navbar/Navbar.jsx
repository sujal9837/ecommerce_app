...
const Navbar = () => {
  // #2c3e50; this should be the color blue
  // #ff6b6b; red
  // #28a745;
  //   #333;
  let location;
      ...
      <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
            <div className='max-w-6xl mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-7 items-center'>
                    <Link to={'/'}><h1 className='font-bold text-3xl'><span className='text-green-500 font-serif'>C</span>herry</h1></Link>
                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    <div className='hidden md:block'>
                        <SignedOut>
                            <SignInButton className="bg-green-500 text-white px-3 py-1 rounded-md cursor-pointer"/>
                        </SignedOut>
                        <SignedIn>
                            <UserButton />
                        </SignedIn>
